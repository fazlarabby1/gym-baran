...
const FullBody = () => {
    return (
        <div className='my-10 md:mt-28 px-5 flex flex-col-reverse md:flex-row justify-between items-center lg:px-44'>
            <Image className='mt-14 md:mt-0 w-[230px] h-[290px] md:w-[390px] md:h-[400px] hover:md:w-[400px]' src={fullBody} alt='' />
            <div>
                ...
                <button className='bg-indigo-900 text-white rounded flex items-center justify-around w-32 md:w-40 py-2 mt-12 hover:btn-success'>Get Started<FaArrowRight className='text-xl text-white' /></button>
            </div>
        </div>
    );
};
